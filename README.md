...
Zen Code 是一个基于 LangGraph 的 AI 编程助手，提供完整的 TUI（终端用户界面）交互体验。支持 Claude Code 和 Gemini CLI 的
核心交互模式，帮助开发者通过自然语言完成编码任务。
...
1. Skills is Memory，仿照 Skills 建立一个 Memory 体系
2. SubAgent 模式继续深挖使用场景
3. SQLite 的初始化问题需要解决
