        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                <input
                    ...
                    required
                    className="w-full px-3 py-2 bg-[var(--color-bg-secondary)] border border-[var(--color-border)] rounded text-[var(--color-text-primary)] placeholder-[var(--color-text-secondary)] focus:outline-none focus:border-[var(--color-primary)]"
                />
            </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 bg-[var(--color-bg-secondary)] border border-[var(--color-border)] rounded text-[var(--color-text-primary)] placeholder-[var(--color-text-secondary)] focus:outline-none focus:border-[var(--color-primary)] resize-none"
                />
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                <input
                    ...
                    readOnly
                    className="w-full px-3 py-2 bg-[var(--color-bg-tertiary)] border border-[var(--color-border)] rounded text-[var(--color-text-secondary)] cursor-not-allowed"
                />
...
export const WorkspaceManageDialog: React.FC<WorkspaceManageDialogProps> = ({ open, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            {/* 对话框 */}
            <div className="relative bg-[var(--color-bg-primary)] border border-[var(--color-border)] rounded-lg shadow-2xl w-full max-w-md max-h-[80vh] overflow-hidden flex flex-col">
                {/* 标题栏 */}
                    ...
                    {mode === 'list' && (
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full px-4 py-3 bg-[var(--color-bg-secondary)] hover:bg-[var(--color-bg-hover)] border border-[var(--color-border)] rounded text-[var(--color-text-primary)] text-left transition-colors"
                            >
                                        ...
                                        >
                                            <div className="flex items-start justify-between gap-3">
                                                ...
                                                <div className="flex items-center gap-1 shrink-0">
                                                    ...
                                                    >
                                                        <svg
                                                            className="w-4 h-4 text-[var(--color-text-secondary)] hover:text-red-400"
                                                            fill="none"
                                                            stroke="currentColor"
                                                            viewBox="0 0 24 24"
                                                        >
