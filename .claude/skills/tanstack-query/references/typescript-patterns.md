...
✅ Always type queryFn return value ✅ Use const assertions for query keys ✅ Leverage queryOptions for reusability ✅
Use Zod for runtime + compile time validation ✅ Enable strict null checks ✅ Create type-safe query key factories ✅
