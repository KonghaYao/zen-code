...
describe('ConfigManager', () => {
    ...
    beforeEach(() => {
        ...
        manager = new ConfigManager(mockConfigStore, mockSkillStore, mockPluginStore, mockRemoteStore);
    });
    ...
    describe('syncSkillsFromRemote', () => {
        ...
        it('should throw error if remote store not configured', async () => {
            ...
            await expect(managerWithoutRemote.syncSkillsFromRemote()).rejects.toThrow('Remote store not configured');
        });
    });
