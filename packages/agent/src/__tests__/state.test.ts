...
import { CodeState, SubAgentStateSchema, CodeAnnotation } from '../state';
...
describe('CodeState', () => {
  it('should have main_model field with default value', () => {
    expect(CodeState.shape.main_model).toBeDefined();
    const field = CodeState.shape.main_model;
  ...
  it('should reject invalid main_model type', () => {
    const invalidState = {
      messages: [],
      main_model: 123,
    };
