 ...
 * @public
 */
export function anthropicPromptCachingMiddleware(middlewareOptions?: PromptCachingMiddlewareConfig) {
    return createMiddleware({
        ...
        wrapModelCall: (request, handler) => {
             ...
             */
            const enableCaching =
                request.runtime.context.enableCaching ?? middlewareOptions?.enableCaching ?? DEFAULT_ENABLE_CACHING;
